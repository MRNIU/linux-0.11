 ...
 */
// Wirzenius 将该程序编写得有可移植性，Torvalds 稍加修改
// Lars Wirzenius 是 Linus 得好友，在 Helsinki 大学时曾同处一间办公室。在 1991 年夏季开发
// Linux 时，Linus 对 C 语言还不是很熟悉，还不会使用可变参数列表函数功能。因此 Lars Wirzenius
// 就为他编写了这段用于内核显示信息的代码。他的主页是 http://liw.iki.fi/liw/.
#include<stdarg.h>  // 标准参数头文件。以宏的形式定义变量参数列 表
#include<string.h>  // 字符串头文件。主要定义了一些有关字符串操作的嵌入函数。
// 我们使用下面的定义，这样我们就可以不用 ctype 库了
